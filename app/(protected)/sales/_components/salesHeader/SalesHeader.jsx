...
// import PurchaseMTabs from "./PurchaseMTabs";

function SalesHeader({ heading, ptext }) {
  return (
      ...
      <div>
        <div className="py-1 flex items-center justify-between w-[95%] mx-auto">
          ...
          <div className="flex  items-center">
            <p className="poppins font-medium text-customblack text-[24px] leading-7 lgdesktop:text-[32px] lgdesktop:leading-10">
              {heading}
            </p>
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center hover:bg-[#DCDFEC] px-3 rounded-md py-1 cursor-pointer gap-2 group">
              <p className=" text-customblack font-normal leading-6 text-sm">
                Activity
              </p>
        ...
        <div className=" w-[95%] mx-auto cursor-pointer">
          <p className="text-grayBlack text-sm font-normal leading-5 mb-3">
            {ptext}
            <span className="text-customblue">{" "}{getLabel('Read_more')}</span>
          </p>
        </div>
      </div>
    </div>
