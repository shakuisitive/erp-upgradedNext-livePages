...
const PickOrderBody = () => {
  ...
  useEffect(() => {
    ...
    let apiData = {
      PromotionApiData: [
        {
          api: PickOrder.GetPickOrderList,
          payload: payload,
