...
import { setRefresh,closeModallForm} from '../_redux/paymentTermSlice'
...
const ModalButtonTooltip = () => {
    let forPayload = useSelector(state => state.paymentTerm.formPayload);
    let objectMatched=useSelector(state => state.paymentTerm.isObjectEqual);
