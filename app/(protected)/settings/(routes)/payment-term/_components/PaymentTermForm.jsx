...
import FormHeader from "./PamentTermFormHeader";
import StatusToolTip from "./ModalFormStatus";
import {isObjectsEqul} from "./customeFunction"
import {setFormPayload,setObjectEqual} from "../_redux/paymentTermSlice"
// const PaymentTermForm = () => {
//   let index = useSelector(state => state.paymentTerm.formIndex);
//   let allData = useSelector(state => state.paymentTerm.paymentMainGrid);
//   let enabled_ = useSelector(state => state.paymentTerm.enabled);
//   console.log("all",);
//   let data=allData.Result.filter(item=>item.PAYTER_ID==index)[0];
