...
import { setEditHead, setHeadReduxT, setRefresh } from "../_redux/paymentTermSlice";
        ...
        <div className="flex text-[14px] gap-[30px] ">
          ...
          <div className=" flex gap-2">
            ...
            <div className="flex items-center">
              <div onClick={()=> dispatch(setRefresh(true))} className="border cursor-pointer hover:bg-customHover rounded-[4px] bg-red-200  border-transparent flex items-center h-fit p-1">
