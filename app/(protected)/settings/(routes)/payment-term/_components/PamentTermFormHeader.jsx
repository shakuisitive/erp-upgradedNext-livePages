...
import PurchaseNewTooltip from "./ModalButtonTooltip";
const FormHeader = () => {
  ...
  useEffect(() => {
    if (data[0]?.APPROVED_FLAG == "Y" && data[0]?.COMPLETE_FLAG == "N" && data[0]?.VOID_FLAG != "Y" ) {
  ...
  return (
    ...
    <button className="flex text-white text-[14px] items-center py-2">
      <span className="mr-2">
        Apply (f4)
      </span>
      <span className="text-white flex items-center border-l border-gray-500 pl-2">
        <IoIosArrowDown />
      </span>
    </button>
  </div> */}
     ...
     <div className="  ">
      ...
      {/* <div className=" mr-3 ml-2 flex pl-3 w-[130px] justify-between rounded-[4px] ">
