...
import Addpayment from "../_components/grid/Addpayment";
import CustomModal from "../../../../../../components/misc/pureComponents/custommodal/CustomModal";
import useApiFetch from "../../../../../../customHook/useApiFetch";
import PaymentTermModall from "./PymentTermFormModal";
// import Paymentstataus from "../_components/grid/Paymentstataus"
import { InlineEditInput } from "./InlineEditInput";
// import Adduom from "../../uom/_components/grid/Adduom"
import { useDispatch, useSelector } from "react-redux";
import { GoHome } from "react-icons/go";
import NewCustomModal from "../../../../../../components/misc/pureComponents/custommodal/NewCustomModal";
import { Administration } from "../../../../../../components/misc/pureComponents/constants/apiConstant";
import Paymentstataus from "../_components/grid/Paymentstataus";
import OpenModal from "./paymentTermOpenModal";
import PaymentTermForm from "./PaymentTermForm";
import PaymentActivity from "../_components/grid/Activitylog";
...
const PaymentTermBody = () => {
  ...
  //useSelectors
  const refreshing = useSelector((state) => state.paymentTerm.refreshing);
  // console.log("refreshing ", refreshing);
  const activityDrawer = useSelector((state) => state.paymentTerm.activityDrawer);
  const formIndex = useSelector((state) => state.paymentTerm.formIndex);
  //   Refs
  ...
  const Drawertabs = [
    {
      ...
      content: <PaymentActivity payloadid={formIndex?.PAYTER_ID} />,
    },
  ];
  ...
  useEffect(() => {
    let apiData = {
      PromotionApiData: [
        {
          api:Administration.GetPaymentTermList,
...
export default PaymentTermBody;
