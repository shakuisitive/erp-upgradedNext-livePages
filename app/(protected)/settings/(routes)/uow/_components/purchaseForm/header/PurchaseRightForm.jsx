...
import { updatePurchaseNotes , updatePurchaseRef} from '../../../redux/Purchase.slice'
...
const Reference = PurchaseDetails[0]?.REFERENCE_NUMBER
  // // console.log("checking purchase ship purchase madiha detail",PurchaseDetails[0]?.NOTES)
    ...
    <div className="flex gap-10 flex-col md:flex-row items-start w-full h-full bg-[#e1eff2] rounded-[6px] shadow-md shadow-blue-50 border border-customgreen px-6  py-3">
      ...
      <div className=" w-full  md:w-1/2  flex flex-col gap-3  mt-[2px]">
        <div className="flex gap-2 ml-2 mt-2">
          ...
          <input onChange={handleInputChangeRef} disabled={false} value={Reference}  type="text" className="w-full bg-white focus:outline-none border focus:border-customGray" />
        </div>
