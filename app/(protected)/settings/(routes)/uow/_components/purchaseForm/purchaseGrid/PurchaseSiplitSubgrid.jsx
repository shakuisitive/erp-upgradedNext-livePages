...
const dispatch = useDispatch()
  ...
  return (
    <div  disabled={ FormStatus == "Issued to Vendor" ? false : true} className=' w-full flex items-center justify-center '>
       <MdCallSplit onClick={openModall} className={`text-green-500 ${FormStatus == "Issued to Vendor" ? "block" : "hidden"} text-[25px]`} />
       <SkuModall isOpen={isOpen} setOpen={setOpen} onClose={onClose} cancelButtonRef={cancelButtonRef} />
        </div>
  )
}
