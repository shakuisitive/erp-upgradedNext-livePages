...
import { setRefreshing } from "../../_redux/uowSlice";

// const UowStatus = ({ rowData, data }) => {
...
//     sendRequest(General.PostUOW, "POST", payloadA, handlePostPartCat, Token);
//   };
...
//       tid: "144",
//     };
//     sendRequest(General.PostUOW, "POST", payloadIn, handlePostPartCat, Token);
//   };
