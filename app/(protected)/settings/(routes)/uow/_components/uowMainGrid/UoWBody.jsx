...
import Adduow from"../grid/Adduow";
...
import UowStatus from "../grid/UowStatus";
...
import { Refresh, closeDrawer,setRefreshing } from "../../_redux/uowSlice";
import UowActivity from "../grid/UowActivity";
...
const  UoWBody = () => {
  ...
  //useSelectors
  const refreshing = useSelector((state) => state.uow.refreshing);
  // console.log("refreshing ", refreshing);
  const activityDrawer = useSelector((state) => state.uow.activityDrawer);
  const formIndex = useSelector((state) => state.uow.formIndex);
  //   Refs
  ...
  const Drawertabs = [
    {
      ...
      content: <ActivityLog payloadid={formIndex?.UOM_ID} />,
    },
  ];
