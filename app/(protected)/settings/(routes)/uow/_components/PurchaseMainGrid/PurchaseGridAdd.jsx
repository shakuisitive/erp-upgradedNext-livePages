...
import {setRefresh , newPurchaseOrder , newPurchase , openNModall}   from '../../redux/Purchase.slice'
...
const dispatch = useDispatch()
    const checkUpdatelist = useSelector((state) => state.PurchaseSlices.VenderOption)
...
useKeyPress(['n'  ], onKeyPress);
  ...
  return (
    <div>
            <div onClick={newFunc}  className="w-full hover:bg-gray-100 flex justify-start ">
                         
                          <CreatableDropdown isDisabled={true} slectedOption={handleChangeOption} value={checkUpdatelist} title={title} handleCreateOption={handleCreateOption} />
                        </div>
