...
import {setRefreshing} from "../../_redux/channelSlice"


const channelStatus = ({ rowData, data }) => {
  ...
  const handleActive = () => {
    const payloadA = {
      data: {
        ...
        TYPE:  rowData.TYPE,
        UOD_ID: rowData.UOD_ID,
        UOV_ID:  rowData.UOV_ID,
        UOW_ID:  rowData.UOW_ID,
        USE_ID:rowData.USE_ID,
        DEFAULT_FLAG: rowData.DEFAULT_FLAG,
        ACTIVE_FLAG: "Y",
      },
