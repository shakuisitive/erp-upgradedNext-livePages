...
import ListViewCardFileTab from '../../../../_components/RightDrawer/ListViewFileTab'
import GridViewCardFileTab from './../../../../_components/RightDrawer/GridViewFileTab'
...
const [isGridView, setIsGridView] = useState(true); 
  ...
  const listView = useSelector(state=>state.paymentTerm.files).filter(item=>item.po_number==po_number);
 const GridView = useSelector(state=>state.paymentTerm.files).filter(item=>item.po_number==po_number);
