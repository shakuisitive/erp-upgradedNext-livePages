...
import Adduom from "../grid/Adduom";
...
import UomStatus from "../grid/UomStatus";
import RightDrawer from "../../../.././../../../components/misc/pureComponents/rightdrawer/RightDrawer";
import { GrHomeRounded } from "react-icons/gr";
import { setRefreshing, closeDrawer } from "../../redux/uomSlice";
import UomActivity from "../grid/UomActivity";
...
const UoMBody = () => {
  ...
  //useSelectors
  const refreshing = useSelector((state) => state.uom.refreshing);
  // console.log("refreshing ", refreshing);
  const activityDrawer = useSelector((state) => state.uom.activityDrawer);
  const formIndex = useSelector((state) => state.uom.formIndex);
  //   Refs
