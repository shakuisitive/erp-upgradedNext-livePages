...
import NewProductGroups from "./customComponents/NewProductGroups";
import EditProductGroups from "./customComponents/EditProductGroups";
import EditProdGroupsNotes from "./customComponents/EditProdGroupsNotes";
import EditProdGroupsName from "./customComponents/EditProdGroupsName";
import ProductGroupsStatus from "./customComponents/ProductGroupsStatus";
import ProductGroupsRightDrawer from "./customComponents/ProductGroupsRightDrawer";
import ProductGroupsActivity from "./customComponents/ProductGroupsActivity";
...
import { closeDrawer, setRefreshing } from "../../_redux/productGroupsSlice";

const ProductGroupsBody = () => {
  //states
  ...
  const refreshing = useSelector(
    (state) => state.productGroupsSlice.refreshing
  );
  const activityDrawer = useSelector(
    (state) => state.productGroupsSlice.activityDrawer
  );
  const formIndex = useSelector((state) => state.productGroupsSlice.formIndex);
  //   Refs
  ...
  const Drawertabs = [
    {
      ...
      content: <ActivityLog payloadid={formIndex?.PARGRO_ID} />,
    },
  ];
  ...
  const [head, setHead] = useState([
    {
      ...
      Modal: ProductGroupsRightDrawer,
      Drawer: ProductGroupsActivity,
    },
    // {
    //   title: "Owner",
    //   slector: "",
    ...
    // },
    {
      title: "Name",
      slector: "NAME",
      customComp: EditProdGroupsName,
      Wid: 150,
    },
    {
      title: "Description",
      slector: "DESCRIPTION",
      customComp: EditProductGroups,
      Wid: 150,
    },
    {
      title: "Notes",
      slector: "NOTES",
      customComp: EditProdGroupsNotes,
      Wid: 150,
    },
    ...
    const gridArr = [
      {
        ...
        footerComp: {
          ...
          GriddFooterAdd: NewProductGroups,
        },
        checkBox: {
  ...
  useEffect(() => {
    let apiData = {
      PromotionApiData: [
        {
          api: Administration.GetPartGroupList,
          payload: payload,
...
export default ProductGroupsBody;
