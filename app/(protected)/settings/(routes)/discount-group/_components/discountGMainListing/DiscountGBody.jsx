...
import NewDiscountG from "./customComponents/NewDiscountG";
import EditDiscountGDesc from "./customComponents/EditDiscountGDesc";
import EditDiscountGPercent from "./customComponents/EditDiscountGPercent";
import EditDiscountGName from "./customComponents/EditDiscountGName";
import DiscountGStatus from "./customComponents/DiscountGStatus";
import DiscountGRightDrawer from "./customComponents/DiscountGRightDrawer";
import DiscountGActivity from "./customComponents/DiscountGActivity";
...
import {
  ...
  setInputData,
  setRefreshing,
} from "../../_redux/DiscountGroupSlice";
...
const DiscountGBody = () => {
  ...
  //useSelectors
  const refreshing = useSelector((state) => state.discountGroup.refreshing);
  const activityDrawer = useSelector(
    (state) => state.discountGroup.activityDrawer
  );
  const formIndex = useSelector((state) => state.discountGroup.formIndex);
  //   Refs
  ...
  const Drawertabs = [
    {
      ...
      content: <ActivityLog payloadid={formIndex?.DISGRP_ID} />,
    },
  ];
  ...
  const [head, setHead] = useState([
    {
      ...
      Modal: DiscountGRightDrawer,
      Drawer: DiscountGActivity,
    },
    // {
    //   title: "Owner",
    //   slector: "",
    ...
    // },
    {
      title: "Name",
      slector: "NAME",
      customComp: EditDiscountGName,
      Wid: 150,
    },
    {
      title: "Description",
      slector: "DESCRIPTION",
      customComp: EditDiscountGDesc,
      Wid: 150,
    },
    {
      title: "Percent",
      slector: "DISCOUNT_PERCENTAGE",
      customComp: EditDiscountGPercent,
      Wid: 150,
    },
