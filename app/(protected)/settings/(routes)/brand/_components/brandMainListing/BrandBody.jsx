...
import BrandEditDesc from "./customComponents/BrandEditDesc";
// import EditProdTypeNotes from "./customComponents/EditProdTypeNotes";
import BrandStatus from "./customComponents/BrandStatus";
import BrandRightDrawer from "./customComponents/BrandRightDrawer";
import BrandActivity from "./customComponents/BrandActivity";
...
const BrandBody = () => {
  ...
  //useSelectors
  const refreshing = useSelector((state) => state.brandSlice.refreshing);
  const activityDrawer = useSelector(
    (state) => state.brandSlice.activityDrawer
  );
  const formIndex = useSelector((state) => state.brandSlice.formIndex);
  //   Refs
  ...
  const Drawertabs = [
    {
      ...
      content: <ActivityLog payloadid={formIndex?.PARBRA_ID} />,
    },
  ];
  ...
  const [head, setHead] = useState([
    {
      ...
      Modal: BrandRightDrawer,
      Drawer: BrandActivity,
    },
    // {
    //   title: "Owner",
    //   slector: "",
  ...
  useEffect(() => {
    let apiData = {
      PromotionApiData: [
        {
          api: Administration.GetPartBrandList,
          payload: payload,
