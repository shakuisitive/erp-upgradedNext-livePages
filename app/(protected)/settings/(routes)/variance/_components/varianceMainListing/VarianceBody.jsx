...
import NewVariance from "./customComponents/NewVariance";
import EditVariance from "./customComponents/EditVariance";
import VarianceStatus from "./customComponents/VarianceStatus";
import VarianceRightDrawer from "./customComponents/VarianceRightDrawer";
import VarianceActivity from "./customComponents/VarianceActivity";
...
import { closeDrawer, setRefreshing } from "../../_redux/varianceSlice";
...
const VarianceBody = () => {
  ...
  //useSelectors
  const refreshing = useSelector((state) => state.varianceSlice.refreshing);
  const activityDrawer = useSelector(
    (state) => state.varianceSlice.activityDrawer
  );
  const formIndex = useSelector((state) => state.varianceSlice.formIndex);
  //   Refs
  ...
  const Drawertabs = [
    {
      ...
      content: <ActivityLog payloadid={formIndex?.PV_TYPE_ID} />,
    },
  ];
  ...
  const [head, setHead] = useState([
    {
      ...
      Modal: VarianceRightDrawer,
      Drawer: VarianceActivity,
    },
    // {
    //   title: "Owner",
    //   slector: "",
  ...
  const payload = {
    ...
    method: "GetProductVarianceTypeList",
    username: "admin",
    type: "rpc",
    tid: "144",
  };
  ...
  useEffect(() => {
    let apiData = {
      PromotionApiData: [
        {
          api: Administration.GetProductVarianceTypeList,
          payload: payload,
