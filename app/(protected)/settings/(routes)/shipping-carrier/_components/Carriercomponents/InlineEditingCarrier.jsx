...
import { updateforRefresh ,addRef,setValidCode,setNextIndex,setRefresh,setInputData} from '../../../tax/redux/taxSlice';
 import {getKeyByCondition} from '../../../../../../../app/(protected)/settings/_components/Functions/customeFunctions'
 const InlineEditingCarrier = ({data, rowData, index}) => {
...
export default  InlineEditingCarrier
