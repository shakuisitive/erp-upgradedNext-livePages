...
import {addFile} from "../redux/supplierSlice"
...
const [isGridView, setIsGridView] = useState(true); 
  ...
  const listView = useSelector(state=>state.supplier.files).filter(item=>item.po_number==po_number);
 const GridView = useSelector(state=>state.supplier.files).filter(item=>item.po_number==po_number);
