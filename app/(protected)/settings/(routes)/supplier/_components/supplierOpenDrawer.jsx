...
import { openForm } from "../redux/supplierSlice";
import { useSelector, useDispatch } from "react-redux";
import useApiFetch from "../../../../../../customHook/useApiFetch";
import {setcloseModall} from "../redux/supplierSlice";
import { GoHome } from "react-icons/go";
import  PaymentTermForm from  './supplierForm'
...
console.log('Drawer',index)
  const tabs = [
    ...
    },
    {
      ...
      label: 'Conversation',
      content: <div>Content for Conversation</div>,
    },
    {
