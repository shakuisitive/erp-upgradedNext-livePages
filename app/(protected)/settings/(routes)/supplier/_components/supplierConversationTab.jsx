...
import {setChatData,setPostLikes} from '../redux/supplierSlice';
...
const ConversationTab = ({data}) => {
  ...
  //conversation
  let data1=useSelector((state)=>state.supplier.editorData); 
  let chatData=useSelector((state)=>state.supplier.ChatData);
...
console.log(newData);
  ...
  let userId=useSelector((state)=>state.supplier.user_ID); 
