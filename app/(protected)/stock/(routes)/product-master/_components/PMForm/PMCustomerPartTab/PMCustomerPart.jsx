...
import AddCustomer from "./customComponents/AddCustomer";
...
const PMCustomerPart = () => {
  ...
  const custList = partNameOverride.filter((item) => item.CUS_ID !== null);
