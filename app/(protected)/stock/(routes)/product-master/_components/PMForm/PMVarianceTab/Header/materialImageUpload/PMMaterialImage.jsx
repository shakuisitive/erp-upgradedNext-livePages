...
const PMMaterialImage = ({ index, onUpload, name, filePath, type }) => {
  ...
  return (
    <div className="flex bg-white px-2 py-2 items-center gap-2">
      ...
      <input
        type="file"
        id={`material-image-${index}`}
        name={`material-image-${index}`}
        style={{ display: "none" }}
...
export default PMMaterialImage;
