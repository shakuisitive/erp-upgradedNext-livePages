...
import PMMaterialMainImage from "./materialImageUpload/PMMaterialMainImage";
import PMMaterialImage from "./materialImageUpload/PMMaterialImage";
import { useSelector } from "react-redux";
import { ItemMaster } from "../../../../../../../../../components/misc/pureComponents/constants/apiConstant";

const PMVarianceMaterial = ({ setMaterials }) => {
  ...
  useEffect(() => {
    const flavors = variances
      .filter((item) => item?.CODE === "material")
      .map((item) => ({
        pvId: item?.PV_ID,
        name: item?.NAME,
...
export default PMVarianceMaterial;
