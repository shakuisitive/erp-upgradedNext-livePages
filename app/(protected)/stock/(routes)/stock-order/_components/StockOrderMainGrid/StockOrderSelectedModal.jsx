...
function StockOrderSelectedModal({ isOpen, closeModal , checkedItems }) {
  return (
    <div className={`fixed w-[100vw] z-[101] bottom-10 ${isOpen ? "block" : "hidden"}`}>
...
export default StockOrderSelectedModal;
