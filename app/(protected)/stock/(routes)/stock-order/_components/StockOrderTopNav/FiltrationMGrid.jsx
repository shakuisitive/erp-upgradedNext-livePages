  ...
  return (
    <div className="w-full mx-auto mt-2 mb-2  text-[14px] text-customblack font-normal">
      <div className="flex items-center ">
        <div  className="bg-[#0073ea] mr-3 ml-2 flex pl-3 w-[130px] justify-between rounded-md cursor-pointer ">
        ...
        <div className="flex text-[14px] gap-[30px] ">
          <div className=" flex gap-2">
            ...
            <div   className="  relative border cursor-pointer text-14px hover:bg-customHover text-customblack rounded-[4px]  border-transparent flex gap-2 items-center p-1">
              ...
              {isOpenF && (
                <div className=" absolute -left-[10px] top-8  max-h-fit overflow-auto mt-2 w-[1200px] bg-gray-50 border  rounded-lg shadow-lg z-[60] p-5  ">
...
<Dropdown  options={checkUpdatelist} optionKey1="SUPPLIER" optionKey2="VEN_ID" onSelectedOptionChanged ={setChangeSp} placeholder=" Product lines to" inputClassName="focus:outline-none w-[150px] hover:bg-transparent  py-2 
        ...
        />
            ...
            >
              ...
              {isOpen && (
                <div className=" absolute -left-[10px] top-8  max-h-[400px] overflow-auto mt-2 w-[360px] bg-gray-50 border  rounded-lg shadow-lg z-[60] p-5  ">
...
return(
    <div className="flex justify-between my-2">
        <div className="flex">
        <input   className="cursor-pointer accent-[#007f9b] " checked={data.hidden == true ? true : false } type="checkbox" />
...
export default FiltrationMGrid;
