...
import { UpdateSku, UpdateSubSku, UpdateSubSplit, setLotList, splitRow } from "../../redux/physicalCountSlice";
import Dropdown from "../../../../../../../components/misc/pureComponents/dropdown/Dropdown";
import { Administration } from "../../../../../../../components/misc/pureComponents/constants/apiConstant";
import useApiFetch from "../../../../../../../customHook/useApiFetch";

const ItemSplit = ({ data, rowData, index, id }) => {
  ...
  const split = () => {
    dispatch(UpdateSubSplit({RID: rowData.PHYCOUDET_ID, PID: id}));
  };
  const handleOnFocus = () => {
    ...
    <div className="w-full h-full flex justify-center items-center pr-2 ">
      <div className="w-full">
        ...
        hover:border-gray-200 text-customblack text-[14px] leading-[21px] font-normal"
          ...
          customFocusKey="s"
          isDisabled={(physicalCountForm.PC_STATUS == "NEW" || physicalCountForm.PC_STATUS  == "Initiated") ? false : true}
