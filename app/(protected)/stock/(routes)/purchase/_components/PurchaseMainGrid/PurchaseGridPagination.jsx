...
const PurchaseGridPagination = () => {
  const dispatch = useDispatch()
  const pageCount = useSelector((state) => state.PurchaseSlices.pageCount);
  const colaps = useSelector(
    (state) => state.receivingSlices.colaps
  );
...
export default PurchaseGridPagination