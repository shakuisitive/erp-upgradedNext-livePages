...
function TabsNav() {
  ...
  const setFilterSku = (e) => {
    ...
    const fil = skuList.filter((data) =>
      data.PAR_CODE.toLowerCase().includes(e.target.value.toLowerCase())
    );
    setSkuListS(fil);
    // // console.log('check out filter', e.target.value, fil);
  };
  const setFilterPo = (e) => {
    ...
    const fil = purchaseMainGrid.filter((data) =>
      data.PO_NUMBER.toLowerCase().includes(e.target.value.toLowerCase())
    );
    setPoListS(fil);
    // console.log('check out filter', e.target.value, fil);
  };
  ...
  const setFilterSp = (e) => {
    ...
    const fil = checkUpdatelist.filter((data) =>
      data.SUPPLIER.toLowerCase().includes(e.target.value.toLowerCase())
    );
    setSpListS(fil);
    // // console.log('check out filter', e.target.value, fil);
  };
  ...
  return (
    <div className="w-full mx-auto mt-2 mb-2  text-[14px] text-customblack font-normal">
      <div className="flex items-center ">
        <div
          onClick={newFunc}
          className="bg-[#0073ea] mr-3 ml-2 flex pl-3 w-[130px] justify-between rounded-md cursor-pointer "
        >
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="  flex justify-between items-center text-customblack hover:bg-slate-10 mt-2 px-3  border border-[#d0d4e4]  ">
                      <Dropdown
                        ...
                        inputClassName="focus:outline-none w-[350px] hover:bg-transparent  py-2 bg-transparent
        hover:border-gray-200 text-customblack text-[14px] leading-[21px] font-normal"
                        dropdownClassName="bg-white w-full border border-customGray rounded-[4px] mt-1 text-customblack shadow-md bg-transparent shadow-gray-400 "
                        customFocusKey=""
                        isDisabled={false}
                        onClearInputValue={false}
                        onHandleFocus={handleOnFocus}
                        onDefaultInput={filterState?.sku}
                    ...
                    <div className="  flex justify-between items-center text-customblack hover:bg-slate-100 mt-2 px-3   border border-[#d0d4e4]  ">
                      <Dropdown
                        ...
                        optionKey1="option"
                        optionKey2="option"
                        onSelectedOptionChanged={setChangeSt}
        ...
        hover:border-gray-200 text-customblack text-[14px] leading-[21px] font-normal"
                    ...
                    <div className="  flex justify-between items-center text-customblack hover:bg-slate-100 mt-2 px-3   border border-[#d0d4e4] ">
                      <Dropdown
                        options={purchaseMainGrid}
                        optionKey1="PO_NUMBER"
                        optionKey2="PO_NUMBER"
        ...
        hover:border-gray-200 text-customblack text-[14px] leading-[21px] font-normal"
                        ...
                        <div
                          id="date"
                          className="text-customblack hover:bg-slate-100 mt-2 px-3   border border-[#d0d4e4] "
                          onClick={onDateAdd2}
                        >
                          <div className="flex justify-between items-center w-full">
                            <span>{isDate2 ? isDate2 : "MM/DD/YYYY"}</span>
                            <FcCalendar />
                          </div>
                        </div>
                        {isDatePicker2 && (
