            ...
            <div
              onClick={() => {
                if (FormStatus == "Initiated") {
                  dispatch(subGridDelete(index));
                }
              }}
              className={`  items-center mr-2  text-[14px] flex cursor-pointer  p-1 hover:bg-gray-100 rounded-md w-full ${
                FormStatus == "Initiated" ? "text-customblack" : "text-gray-200"
              } `}
            >
