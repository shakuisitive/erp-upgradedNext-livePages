...
// import TabsNav from '../../../../../../../components/misc/globalComponents/landingNavebar/TabsNav';
import TabsNav from './ReceivingMTabs'


function ReceivingMHeader({heading,ptext}) {
  return (
...
export default ReceivingMHeader