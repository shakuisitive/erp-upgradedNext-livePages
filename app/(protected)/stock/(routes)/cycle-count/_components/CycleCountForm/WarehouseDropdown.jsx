...
import { Administration, PhysicalCount } from "../../../../../../../components/misc/pureComponents/constants/apiConstant";
...
const WarehouseDropdown = ({ disable }) => {
  ...
  const checkUpdatelist = useSelector(
    (state) => state.CycleCountSlice.wareHouse
  );
  ...
  const handleSelectedOptionChange = (option) => {
    ...
    sendRequest(
      PhysicalCount.GetAutoTransferDetailsList,
      "POST",
      autoTransferList,
      transferList,
      token
  ...
  return (
    <div>
      <Dropdown
        ...
        onDefaultInput={CycleCountForm?.INVENTORY}
        // showValue=""
