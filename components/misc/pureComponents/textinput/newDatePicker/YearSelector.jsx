...
const YearSelector = ({ selectedYear, onChange, isYearsVisible, setIsYearsVisible, setIsMonthsVisible, isMonthsVisible, setPastYears }) => {
  ...
  const years = Array.from(
    { length: 21 },
    (_, index) => selectedYear - setPastYears + index
  );
