...
const DatePicker = ({onDateChange, setIsDatePicker}) => {
  ...
  return (
    <div className="box-border overflow-hidden relative w-[226px] text-black text-xs border rounded-md bg-white shadow-lg flex-col flex justify-center items-center">
