...
import {setChatData,setPostLikes} from './DrawerSlice';
import { Message } from "./Message";
import {getCurrentDateTime,timeAgo} from './Functions';
...
const ConversationTab = ({data}) => {
  ...
  //conversation
  let data1=useSelector((state)=>state.Drawer.editorData); 
  let chatData=useSelector((state)=>state.Drawer.ChatData);
