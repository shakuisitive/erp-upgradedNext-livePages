...
const GridAction = ({ data, rowData, index, obj , onHandleClick }) => {
  ...
  return (
    ...
    //   onMouseEnter={() => onHover()}
      onClick={() => onHandleClick ? onHandleClick(index , data , rowData) : onSubmit}
    style={{backgroundColor: rowData?.color ? rowData?.color : '#007f9b' }}
